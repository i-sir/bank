 ...
 *     "test_environment"        =>"http://bank.ikun:9090/api/wxapp/init/index",
 *     "official_environment"    =>"http://xcxkf213.aubye.com/api/wxapp/init/index",
 * )
 */
class InitController
{
     ...
     * @param $child_id 子级id
     *                  http://xcxkf213.aubye.com/api/wxapp/init/send_invitation_commission?p_user_id=1
     */
